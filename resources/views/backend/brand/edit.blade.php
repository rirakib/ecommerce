        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="{{route('brand.update',$brand->id)}}" method="POST"
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Brand Name <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="name" name="name" value="{{$brand->name}}" required="required"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="short_description"
                                        ...
                                        type="text" value="{{$brand->short_description}}" name="short_description" placeholder="Maximum 40 words">
                            ...
                            <div class="form-group">
                                <label for="image" class="control-label col-md-3 col-sm-3 col-xs-12">Brand Image
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="image"
